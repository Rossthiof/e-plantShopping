...
function ProductList({ onHomeClick }) {
    ...
    // ✅ Task 4: Funktion zum Berechnen der Gesamtanzahl
    ...
    // ✅ Task 1: Funktion für Add to Cart
    const handleAddToCart = (plant) => {
        dispatch(addItem(plant)); // global zu CartSlice
        setAddedToCart((prev) => ({
            ...prev,
            [plant.name]: true
        }));
            ...
            <div className="navbar" style={styleObj}>
                ...
                <div style={styleObjUl}>
                    ...
                    <div style={{ position: "relative" }}> 
                        ...
                        {/* ✅ Task 4: Anzeige der Gesamtanzahl am Warenkorb-Icon */}
